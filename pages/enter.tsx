...
export default function Enter() {
    ...
    return (
        <div className="mt-16 px-4">
            <h3 className="text-3xl font-bold text-center">Enter to Market</h3>
            <div className="mt-16">
                ...
                <form className="flex flex-col mt-8">
                    ...
                    <div className="mt-1">
                        {method === "email" ? (
                            <input
                                type="email"
                                className="
                                    appearance-none w-full px-4 py-2
                            ...
                            <div className="flex rounded-md shadow-sm">
                                <span
                                    className="
                                        ...
                                        px-3 border border-r-0 rounded-l-md
                    ...
                    <button
                        className="
                            ...
                            mt-5 py-2 px-4 border border-transparent rounded-md shadow-sm
                            text-sm font-medium
