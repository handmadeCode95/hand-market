        ...
        <div className="py-16 px-4 space-y-8">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
                <div key={i} className="flex flex-col items-start">
                    ...
                    <div className="mt-2 to-gray-700">
                        <span className="text-indigo-500 font-medium">Q.</span>{" "}
                        What is the best mandu restaurant?
                    </div>
                    <div className="mt-5 flex items-center justify-between w-full text-gray-500 font-medium text-sm">
                        <span>니꼬</span>
                        <span>18시간 전</span>
                    </div>
            ...
            <button className="fixed bottom-12 right-5 bg-indigo-400 rounded-full p-4 shadow-xl text-white hover:bg-indigo-500 cursor-pointer transition-colors">
                <svg
                    className="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
